"""This is xiyuwang's own segment that replaces cwd.

Besides cwd, it also shorten the worktree paths.

"""
import os
import sys
from ..utils import warn, py3, BasicSegment
from cwd import replace_home_dir
from cwd import split_path_into_names
from cwd import requires_special_home_display
from cwd import maybe_shorten_name
from cwd import get_fg_bg
